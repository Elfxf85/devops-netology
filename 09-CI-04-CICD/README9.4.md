...
1. Создал Freestyle Job, который запускает `molecule test` из моего [репозитория](https://github.com//vector-role-m) с ролью vector-role:
...
3. Перенес Declarative Pipeline в файл [Jenkinsfile](https://github.com/Elfxf85/devops-netology/tree/main/vector-role-m/blob/main/Jenkinsfile).
...
7. Изменения внесенные в Pipeline находятся в файле [`ScriptedJenkinsfile`](https://github.com/Elfxf85/devops-netology/tree/main/ScriptedJenkinsfile)

8. Репозиторий, на котором тестировался запуск Freestyle Job и Declarative Pipeline Job с запуском `molecule test`: https://github.com/Elfxf85/devops-netology/tree/main/vector-role-m

Ссылка на Declarative Pipeline: https://github.com/Elfxf85/devops-netology/tree/main/vector-role-m/blob/main/Jenkinsfile
